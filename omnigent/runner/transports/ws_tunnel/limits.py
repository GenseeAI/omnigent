"""Deprecated alias for :mod:`omnigent.tunnel_limits`; removal target 0.16.0.
...
No in-tree module imports this — new code imports :mod:`omnigent.tunnel_limits`.
"""

from __future__ import annotations

from omnigent.tunnel_limits import (
